...
test('test', async ({ page }) => {
  const outputFile = './temp/olympics-medals-weighted.csv'
  writeFileSync(
    outputFile,
    'year,rank,country,weighted_medals,gold,silver,bronze,population,population_per_weighted_medal\n'
  )
  await page.goto('https://www.medalspercapita.com/#weighted-per-capita')
